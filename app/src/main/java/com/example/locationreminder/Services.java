...
public final class Services{
    ...
    public static final void sendNotification( Context context,  String message,  LatLng latLng,String title,String description) {
        ...
        Notification notification = new NotificationCompat.Builder(context, CHANNEL_NOTIFICATION).setSmallIcon(R.drawable.reminder_logo).setContentTitle(title).setContentText("approaching destination:"+(CharSequence)message).setAutoCancel(true).build();
